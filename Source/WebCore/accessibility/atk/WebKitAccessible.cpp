...
static void setAtkRelationSetFromCoreObject(AccessibilityObject* coreObject, AtkRelationSet* relationSet)
{
    ...
    if (coreObject->isControl()) {
        ...
        AccessibilityObject::AccessibilityChildrenVector ariaLabelledByElements = coreObject->labelledByObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector labels = coreObject->labelForObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector ariaFlowToElements = coreObject->flowToObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector flowFrom = coreObject->flowFromObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector ariaDescribedByElements = coreObject->describedByObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector describers = coreObject->descriptionForObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector ariaControls = coreObject->controlledObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector controllers = coreObject->controllers();
    ...
    AccessibilityObject::AccessibilityChildrenVector ariaOwns = coreObject->ownedObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector owners = coreObject->owners();
    ...
    AccessibilityObject::AccessibilityChildrenVector ariaDetails = coreObject->detailedByObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector details = coreObject->detailsForObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector ariaErrorMessage = coreObject->errorMessageObjects();
    ...
    AccessibilityObject::AccessibilityChildrenVector errors = coreObject->errorMessageForObjects();
...
static AtkAttributeSet* webkitAccessibleGetAttributes(AtkObject* object)
{
    ...
    // The Core AAM states the author-provided value should be exposed as-is.
    auto& keyShortcuts = coreObject->keyShortcutsValue();
